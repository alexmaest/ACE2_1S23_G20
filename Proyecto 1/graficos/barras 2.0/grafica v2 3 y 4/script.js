...
myCanvas.height = window.innerHeight * 0.95;  // =alto del marco canvas   550
...
function SUMMIT() {
  ...
  var param = "validacion de que el usuario este sentado a lo largo del tiempo"
  var paramY = "Esta Sentado"
  var paramX = "tiempo"
...
function drawBar(
  ...
  //--------new
  this.ctx.save();
  this.ctx.translate(upperLeftCornerX+9, puntoX);
...
class BarChart {
  ...
  drawLegend() { // dibuja los cuadros de color con su label respectivo, identificador de que cosa representa cada una de las barras
    ...
    for (let ctg of Object.keys(this.options.data)) {
      ...
      li.style.rotate = "-0.25turn"   // rotar a 90

      // li.style.display="inline"

      /*li.style.borderLeft =
        "20px solid " + this.colors[0];*/
...
var myBarchart = new BarChart({
  ...
  //en colors puede ir bien una lista larga por default 200 datos max
