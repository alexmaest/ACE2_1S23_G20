...
function drawLine(ctx, startX, startY, endX, endY, color) {
  ...
  myCanvas.width = 500;   //ancho del marco canvas
  myCanvas.height = 500;  // =alto del marco canvas
  ...
  myBarchart.options.seriesName = "Fifa mobile"
  ...
  function draw() {
    ...
    for (var i = 0; i < values.length; i++) {
      ...
      countries.push({ ['color']: values2[0], ['valor']: values2[1] })
    }
  
    var final = convertArrayToObject(countries, 'color',)//paso de array a objeto
    console.log(final);
  
    //se lo asigno a myBarchart options
